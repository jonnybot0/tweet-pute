...
<html>
    ...
    <body>
        ...
        <div id="show-hashtag" class="content scaffold-show" role="main">
            ...
            <f:display bean="hashtag" />
            </ol>
            <g:form resource="${hashtag}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${hashtag}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
